...
GeneratedQuestionFormat = (
    "Question_Type: {Question_Type}, Transcript: {Context}, Question: {Question}\n"
...
refiner_examples = [
    {
        "Original_Question": GeneratedQuestionFormat.format(
            ...
            Answer="False",
            Options=None,  # T/F should be None here or MCQ list
        ...
        "New_Question": NewQuestionFormat.format(
            ...
            Answer="B",
            Options=[
                "A. To reduce memory usage during search",
            ...
            Explanation="Binary search requires sorted data because it works by repeatedly dividing the search interval in half..."
        ),
    },
    {
        "Original_Question": GeneratedQuestionFormat.format(
            Question_Type="T/F",
            Context="Arrays are data structures...",
            Question="Arrays provide O(1) access time to elements?",
            Answer="False",
            Options=None,  # T/F must be None
            Explanation="Arrays provide O(1) constant time access to elements."
        ),
        "Feedback": "...",
        "New_Question": NewQuestionFormat.format(
            Question_Type="T/F",
            Question="Arrays provide O(1) constant time access to elements regardless of array size.",
            Answer="True",
            Options=None,
            Explanation="According to the transcript, arrays provide O(1) access time to any element."
        ),
    }
]
# ------------------------------
...
few_shot_prompt = FewShotChatMessagePromptTemplate(
    example_prompt=ChatPromptTemplate.from_messages([
        ...
        ("system", "Generate only new question with proper format."),
